...
export default function MedicalOverviewSection() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      setError('Failed to sync intelligence nodes');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return (
      <div className="py-20 flex flex-col items-center justify-center space-y-4 opacity-30">
        ...
        <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Synchronizing Medical Ops...</p>
      </div>
    );
  }
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div className="p-8 rounded-3xl bg-white border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                <div className="relative z-10">
                   ...
                   <h3 className="text-[11px] font-black uppercase tracking-wider text-slate-400 mb-2">Patient Appointments</h3>
             ...
             <div className="p-8 rounded-3xl bg-white border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                <div className="relative z-10">
                   ...
                   <h3 className="text-[11px] font-black uppercase tracking-wider text-slate-400 mb-2">Emergency Alerts</h3>
          ...
          <div className="flex flex-col gap-8">
             <div className="p-8 rounded-3xl bg-slate-900 text-white relative overflow-hidden group shadow-xl">
                ...
                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-400 mb-4">Official Bulletin</h4>
             ...
             >
                <div className="text-left">
                   <h4 className="text-[10px] font-black uppercase tracking-[0.2em] mb-1 text-indigo-600 group-hover:text-indigo-100">Messaging Center</h4>
                   <p className="text-2xl font-black uppercase tracking-tight">Access Communications</p>
                </div>
