...
import MedicalOfficerArticleHub from '../../features/medical/components/MedicalOfficerArticleHub';
...
export default function MedicalOfficerDashboard() {
  ...
  const fetchDashboardData = async () => {
    ...
    const fetchArticlesTask = fetch(`${BASE_URL}/medical-officer/articles/my-articles`, {
