          ...
          <form onSubmit={handleLoginSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Security Pass-Cipher</label>
                <Link to="/medical-officer/forgot-password" className="text-[10px] font-black uppercase tracking-widest text-indigo-400 hover:text-indigo-300">Forgot Cipher?</Link>
              </div>
              <div className="relative group/field">
                <div className="absolute inset-y-0 left-5 flex items-center text-slate-500 group-focus-within/field:text-indigo-400 transition-colors">
                  <Lock size={18} />
