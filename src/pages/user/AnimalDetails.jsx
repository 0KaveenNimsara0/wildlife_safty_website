...
import { fetchAnimalImage } from '../../features/animals/api';
import animalsData from '../../features/animals/data/sri_lanka_snakes_data.json';
...
const AnimalDetails = () => {
  ...
  useEffect(() => {
    const fetchImage = async () => {
      setLoading(true);
      const imageUrl = await fetchAnimalImage(selectedAnimal['Common English Name(s)']);
      setImage(imageUrl);
      setLoading(false);
    };
