                ...
                <div className="grid lg:grid-cols-12 gap-12 mb-20">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="flex items-center space-x-3">
                            <div className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center p-2 border border-white/5 shadow-xl group cursor-pointer overflow-hidden relative">
                            ...
                            <h3 className="text-2xl font-black tracking-tight bg-gradient-to-r from-emerald-400 via-sky-400 to-emerald-200 bg-clip-text text-transparent">
                                WildLife Safety
                            </h3>
                        </div>
